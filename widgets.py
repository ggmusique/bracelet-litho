...
class PlaceholderPanel(ctk.CTkFrame):
    """Panneau générique 'en construction'."""

    def __init__(
        self,
        parent,
        icon: str = "🚧",
        message: str = "En construction",
        detail: str = "Cette section sera disponible dans une prochaine phase.",
        **kwargs,
    ) -> None:
        kwargs.setdefault("fg_color", theme.BG_CARD)
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=12),
            text_color=theme.TEXT_SECONDARY,
        ).pack(expand=True, pady=(0, 50))


class SectionLabel(ctk.CTkLabel):
    """Libellé de section (titre de groupe, style secondaire)."""
